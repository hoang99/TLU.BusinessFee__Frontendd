...
class DuyetDeXuatThanhToan extends Component {
              ...
              <div className="modal-content">
                ...
                <div className="modal-footer">
                  ...
                  <button
                    type="button"
                    className="btn btn-primary"
                    onClick={() => this.tuChoiDeXuat(value.maDeXuat)}
                  >
                    OK
                  </button>
                </div>
  ...
  hienThiBtnDuyet_TuChoi = (value) => {
    if (
      this.state.dataUsers.roleID === "RL03" &&
      value.tinhTrang.indexOf("Chua xet duyet") !== -1
    ) {
      return (
        <td>
          <div>
            <div className="btn btn-primary btn-group ml-2">
              <div
                ...
                onClick={() => this.duyetDeXuat(value.maDeXuat, value)}
              >
                {" "}
                Duyệt
              </div>
            ...
            <div className="btn btn-danger btn-group ml-2">
              <div
                ...
                data-toggle="modal"
                data-target="#tuChoi"
                onClick={() => this.layMaTuChoi(value.maDeXuat)}
              >
                {" "}
                Từ chối
              </div>
    ...
    if (
      ...
      value.tinhTrang.indexOf("Truong bo phan da duyet") !== -1
    ) {
      return (
        <td>
          <div>
            <div
              className="btn btn-primary btn-group ml-2"
              style={{ fontSize: "22px" }}
            >
              <div
                className="fa fa-edit"
    ...
    if (
      ...
      value.tinhTrang.indexOf("Phong ke toan da xet duyet") !== -1
    ) {
      return (
        <td>
          <div>
