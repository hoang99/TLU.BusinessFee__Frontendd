    ...
    return (
      <h6 style={{ textAlign: "left" }}>
        ...
        <p
          ...
          style={{ display: "inline", fontSize: "20px", fontWeight: "bold" }}
        >
          {this.state.layTenNhanVienDeXuat}
        </p>
      </h6>
    );
  };
  ...
  thanhToan = (valueMaChuyenCongTac, maHoaDon, maDeXuat) => {
    if (window.confirm("Bạn có chắc chắn thanh toán")) {
      ...
      axios({
        method: "POST",
        url:
          "https://localhost:5001/api/ThanhToan?MaHoaDon=" +
          maHoaDon +
          "&MaDeXuat=" +
          maDeXuat,
        data: null,
      ...
      <tr className="tr__canGiua">
        ...
        <td>
          <a
            ...
            data-target="#chiTiet"
            onClick={() =>
              this.layMaChuyenCongTac(
                value.maChuyenCongTac,
                value,
                value.tenNhanVienDeXuat
              )
            }
          >
            Chi tiết
                  ...
                  <div className="card-body">
                    <div className="form-group">
                      <div className="form-group">
                        <div
                          className="row"
                          style={{ padding: "0px 0px 0px 200px" }}
                        >
                          <div className="col-6">
                            <h6 style={{ textAlign: "left" }}>
                              Mã hóa đơn: {this.state.layDataChiTiet.maHoaDon}
                            </h6>
                            <h6 style={{ textAlign: "left" }}>
                              Mã đề xuất: {this.state.layDataChiTiet.maDeXuat}
                            </h6>
                            <h6 style={{ textAlign: "left" }}>
                              Tên CTT:{" "}
                              {this.state.layDataChiTiet.tenChuyenCongTac}
                            </h6>
                          </div>
                          <div className="col-6">
                            <h6 style={{ textAlign: "left" }}>
                              Số nhân viên:{" "}
                              {this.state.layDataChiTiet.soNhanVien}
                            </h6>
                            <h6 style={{ textAlign: "left" }}>
                              Thời gian đề xuất:{" "}
                              {this.state.layDataChiTiet.thoiGianDeXuat}
                            </h6>
                          </div>
                        </div>
                        ...
                        >
                          ...
                          {this.state.layDataChiTiet.tongChiPhi} (VND)
                        </p>
                        <div className="row mt-3">
                          <div className="col-6">
                            <h5>Người nộp </h5>
  ...
  hienThiBtnThanhToan = (value) => {
    ...
    if (value.tinhTrang === "Ban lanh dao da xet duyet") {
      return (
        <td>
          <div
            className="btn btn-primary thanh-toan"
            style={{ fontSize: "22px" }}
          >
            <div
    ...
    if (
      value.tinhTrang.indexOf("Phong ke toan") !== -1 ||
      value.tinhTrang.indexOf("Truong bo phan") !== -1
    ) {
      return (
        <td>
          <div className="btn btn-warning thanh-toan">
            <div className="fa fa-edit" id="thanhToan">
              <span className="ml-2">Đang xét duyệt</span>
            </div>
          </div>
        </td>
      );
