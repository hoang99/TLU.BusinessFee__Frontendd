...
class AlertComponent extends Component {
  alert = () => {
    ...
    if (this.props.alertReducer.onTrangThaiThemMoiThanhCong === true) {
      return (
        <Alert
          type="success"
          onDismiss={() => this.props.alertOff_TrangThaiThemMoiThanhCong()}
          timeout={5000}
        >
          Thêm mới thành công
        </Alert>
    ...
    if (this.props.alertReducer.onTrangThaiThemMoiThatBai === true) {
      return (
        <Alert
          type="danger"
          onDismiss={() => this.props.alertOff_TrangThaiThemMoiThatBai()}
          timeout={5000}
        >
          Thêm mới thất bại
        </Alert>
    ...
    if (this.props.alertReducer.onTrangThaiSuaThanhCong === true) {
      return (
        <Alert
          type="success"
          onDismiss={() => this.props.alertOff_TrangThaiSuaThanhCong()}
          timeout={5000}
        >
          Sửa thành công
        </Alert>
    ...
    if (this.props.alertReducer.onTrangThaiSuaThatBai === true) {
      return (
        <Alert
          type="danger"
          onDismiss={() => this.props.alertOff_TrangThaiSuaThatBai()}
          timeout={5000}
        >
          Sửa thất bại
        </Alert>
    ...
    if (this.props.alertReducer.onTrangThaiXoaThanhCong === true) {
      return (
        <Alert
          type="success"
          onDismiss={() => this.props.alertOff_TrangThaiXoaThanhCong()}
          timeout={5000}
        >
          Xóa thành công
        </Alert>
    ...
    if (this.props.alertReducer.onTrangThaiXoaThatBai === true) {
      return (
        <Alert
          type="danger"
          onDismiss={() => this.props.alertOff_TrangThaiXoaThatBai()}
          timeout={5000}
        >
          Xóa thất bại
        </Alert>
    ...
    if (this.props.alertReducer.onTrangThaiDuyetThanhCong === true) {
      return (
        <Alert
          type="success"
          onDismiss={() => this.props.alertOff_TrangThaiDuyetThanhCong()}
          timeout={5000}
        >
          Duyệt thành công
        </Alert>
    ...
    if (this.props.alertReducer.onTrangThaiDuyetThatBai === true) {
      return (
        <Alert
          type="danger"
          onDismiss={() => this.props.alertOff_TrangThaiDuyetThatBai()}
          timeout={5000}
        >
          Duyệt thất bại
        </Alert>
    ...
    if (this.props.alertReducer.onTrangThaiTuChoiDuyetThanhCong === true) {
      return (
        <Alert
          type="success"
          onDismiss={() => this.props.alertOff_TrangThaiTuChoiDuyetThanhCong()}
          timeout={5000}
        >
          Từ chối duyệt{" "}
        </Alert>
    ...
    if (this.props.alertReducer.onTrangThaiTuChoiDuyetThatBai === true) {
      return (
        <Alert
          type="danger"
          onDismiss={() => this.props.alertOff_TrangThaiTuChoiDuyetThatBai()}
          timeout={5000}
        >
    ...
    if (this.props.alertReducer.onTrangThaiThanhToanThanhCong === true) {
      return (
        <Alert
          type="success"
          onDismiss={() => this.props.alertOff_TrangThaiThanhToanThanhCong()}
          timeout={5000}
        >
    ...
    if (this.props.alertReducer.onTrangThaiThanhToanThatBai === true) {
      return (
        <Alert
          type="danger"
          onDismiss={() => this.props.alertOff_TrangThaiThanhToanThatBai()}
          timeout={5000}
        >
          Thanh toán thất bại
        </Alert>
    ...
    if (this.props.alertReducer.onTrangThaiQuyenThanhCong === true) {
      return (
        <Alert
          type="success"
          onDismiss={() => this.props.alertOff_TrangThaiQuyenThanhCong()}
          timeout={5000}
        >
          Có quyền{" "}
        </Alert>
    ...
    if (this.props.alertReducer.onTrangThaiQuyenThatBai === true) {
      return (
        <Alert
          type="danger"
          onDismiss={() => this.props.alertOff_TrangThaiQuyenThatBai()}
          timeout={5000}
        >
  ...
  render() {
    return <AlertContainer>{this.alert()}</AlertContainer>;
  }
}
...
const mapDispatchToProps = (dispatch, ownProps) => {
  return {
    ...
    alertOn_TrangThaiThanhToanThanhCong: () => {
      dispatch(actions.alertOn_TrangThaiThanhToanThanhCong());
    },
    alertOff_TrangThaiThanhToanThanhCong: () => {
      dispatch(actions.alertOff_TrangThaiThanhToanThanhCong());
    },
    alertOn_TrangThaiThanhToanThatBai: () => {
      dispatch(actions.alertOn_TrangThaiThanhToanThatBai());
    },
    alertOff_TrangThaiThanhToanThatBai: () => {
      dispatch(actions.alertOff_TrangThaiThanhToanThatBai());
    },
