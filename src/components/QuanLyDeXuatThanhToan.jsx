          ...
          {value.tinhTrang === "Chua xet duyet" ? (
            <div className="btn btn-danger btn-group ml-2">
              <div
                ...
                onClick={() => this.onDeleteDeXuatThanhToan(value.maDeXuat)}
              >
                {" "}
                Xóa
              </div>
        ...
        <div class="row-container">
          ...
          <div className="table-manager" style={{ padding: "0 25px 0 0" }}>
            <div className="heading-manager">
              <i></i> Quản lý đề xuất thanh toán
            </div>
                  ...
                  <div className="modal-content">
                              ...
                              <div className="row">
                                ...
                                <div className="col-6">
                                  ...
                                  <select
                                    ...
                                    onChange={(event) =>
                                      this.onChangeSoNhanVien(event)
                                    }
                                  >
                                    <option selected>
                                      Chọn chuyến công tác
                                    </option>
                    ...
                    <div className="modal-footer">
                      ...
                      <button
                        type="button"
                        className="btn btn-primary"
                        onClick={() => this.themMoiDeXuatThanhToan()}
                      >
                        Thêm mới
                      </button>
                    </div>
