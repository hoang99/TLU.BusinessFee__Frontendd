  ...
  onSua = () => {
    if (window.confirm("Bạn có chắc chắn muốn sửa")) {
      ...
      dataSua.soTienDinhMuc = this.state.soTienDinhMuc
        ? this.state.soTienDinhMuc
        : this.state.hienThiSuaUer.soTienDinhMuc;
      dataSua.donVi = this.state.donVi
        ? this.state.donVi
        : this.state.hienThiSuaUer.donVi;
  ...
  onDelete = (maCapBac, maChiPhi) => {
    if (window.confirm("Bạn có chắc chắn muốn xóa")) {
      ...
      var tempData = this.state.data.filter(
        (item) => item.maCapBac !== maCapBac || item.maChiPhi !== maChiPhi
      );
        ...
        <td>
                        ...
                        <div className="form-group">
                          <div className="form-group">
                            ...
                            <input
                              ...
                              placeholder="Tiền định mức (VND)"
                              name="soTienDinhMuc"
                              Value={this.state.hienThiSuaUer.soTienDinhMuc}
                              onChange={(event) => this.onChange(event)}
                            />
                            ...
                            <input
                              ...
                              placeholder="Đơn vị"
                              name="donVi"
                              Value={this.state.hienThiSuaUer.donVi}
                              onChange={(event) => this.onChange(event)}
                            />
                          </div>
                        </div>
          ...
          <div className="btn btn-danger btn-group ml-2">
            <div
              ...
              onClick={() => this.onDelete(value.maCapBac, value.maChiPhi)}
            >
              Xóa
            </div>
          </div>
                          ...
                          <div className="form-group">
                            <div className="form-group">
                              ...
                              <input
                                ...
                                id
                                aria-describedby="helpId"
                                placeholder="Số tiền định mức (VND)"
                                name="soTienDinhMuc"
                                onChange={(event) => this.onChange(event)}
                              />
                              <p style={{ textAlign: "left" }}>Đơn vị</p>
