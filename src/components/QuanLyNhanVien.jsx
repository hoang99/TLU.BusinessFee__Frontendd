...
class QuanLyNhanVien extends Component {
  ...
  hienThiTenPhongBan = () => {
    return this.state.dataPhongBan.map((value, key) => (
      <option
        selected={value.tenPhongBan === this.state.hienThiSuaUer?.tenPhongBan}
      >
        {value.tenPhongBan}
      </option>
    ));
  ...
  onSua = () => {
    if (window.confirm("Bạn có chắc chắn muốn sửa")) {
      ...
      dataSua.tenNhanVien = this.state.tenNhanVien
        ...
        : this.state.hienThiSuaUer?.tenNhanVien;
      dataSua.tenCapBac = this.state.tenCapBac
        ? this.state.tenCapBac
        : this.state.hienThiSuaUer?.tenCapBac;
                        ...
                        <div className="form-group">
                          <div className="form-group">
                            ...
                            <input
                              ...
                              Value={this.state.hienThiSuaUer.tenNhanVien}
                              name="tenNhanVien"
