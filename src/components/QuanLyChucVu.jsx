...
class QuanLyCapBac extends Component {
  ...
  onSua = () => {
    ...
    dataSua.tenCapBac = this.state.tenCapBac
      ...
      : this.state.hienThiSuaCapbac.tenCapBac;
    dataSua.moTa = this.state.moTa
      ? this.state.moTa
      : this.state.hienThiSuaCapbac.moTa;
    console.log(dataSua);
        ...
        <td>
                        ...
                        <div className="form-group">
                          <div className="form-group">
                            ...
                            <input
                              ...
                              Value={this.state.hienThiSuaCapbac.maCapBac}
                              name="maCapBac"
                            ...
                            <input
                              ...
                              id
                              aria-describedby="helpId"
                              Value={this.state.hienThiSuaCapbac.tenCapBac}
                              name="tenCapBac"
                              onChange={(value) => this.onChange(value)}
                            />
                            ...
                            <input
                              ...
                              id
                              aria-describedby="helpId"
                              Value={this.state.hienThiSuaCapbac.moTa}
                              name="moTa"
                              onChange={(value) => this.onChange(value)}
                            />
                          </div>
          ...
          <div className="btn btn-danger btn-group ml-2">
            <div
              ...
              onClick={() => this.onDelete(value.maCapBac)}
            >
              {" "}
              Xóa
            </div>
