  ...
  onSua = () => {
    if (window.confirm("Bạn có chắc chắn muốn sửa")) {
      ...
      dataSua.tenChiPhi = this.state.tenChiPhi
        ? this.state.tenChiPhi
        : this.state.hienThiSuaUer.tenChiPhi;
        ...
        <td>
                        ...
                        <div className="form-group">
                          <div className="form-group">
                            ...
                            <input
                              ...
                              Value={this.state.hienThiSuaUer.tenChiPhi}
                              name="tenChiPhi"
          ...
          <div className="btn btn-danger btn-group ml-2">
            <div
              ...
              onClick={() => this.onDelete(value.maChiPhi)}
            >
              Xóa
            </div>
          </div>
